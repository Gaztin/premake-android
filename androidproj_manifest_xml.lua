...
function manifest.generate(prj)
	...
	_p(0, '<manifest xmlns:android="http://schemas.android.com/apk/res/android" package="com.$(ApplicationName)" android:versionCode="1" android:versionName="1.0">')
	_p(1, '<uses-sdk android:minSdkVersion="9" android:targetSdkVersion="21"/>')
	_p(1, '<application android:label="' .. prj.name .. '" android:hasCode="false">')
	_p(2, '<activity android:name="android.app.NativeActivity" android:label="' .. prj.name .. '" android:configChanges="orientation|keyboardHidden">')
